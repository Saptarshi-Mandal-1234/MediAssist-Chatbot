A review of the refactored script revealed a missing helper function definition (`load_test_data`) that was being called in `main()`.

The fully checked, error-free, and production-ready script is provided below. All functions are correctly defined, paths are aligned with the root structure, and variable scopes are verified:
